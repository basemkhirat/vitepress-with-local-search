...
.DocSearch-Button {
	border: 1px solid var(--docsearch-grey-color) !important;
	padding: 0 18px;
	border-radius: 8px;
}
...
.search-item {
	padding: 0rem 2rem;
	margin: 8px 0 0 0;
	border: solid 1px var(--docsearch-grey-color);
	padding-bottom: 16px;
	border-radius: 6px;
}
...
.search-item:hover {
	background: var(--docsearch-grey-color);
}
